...
presplash.filename = %(source.dir)s/assests/splashscreen.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assests/app_icon.png
...
android.permissions = android.permission.INTERNET, android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE, android.permission.ACCESS_FINE_LOCATION, android.permission.ACCESS_COARSE_LOCATION, android.permission.RECORD_AUDIO
