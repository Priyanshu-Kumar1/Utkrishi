...
from kivy.properties import NumericProperty, ListProperty, VariableListProperty, ColorProperty, StringProperty
...
<SearchBar>
    ...
    MDFloatLayout:
        ...
        TextInput:
            ...
            on_touch_down: if self.collide_point(*args[1].pos): root.on_input_focus(self)
            on_text_validate: root.close_search_view()
